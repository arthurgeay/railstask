...
class ProjectUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_user" do
    assert_difference('ProjectUser.count') do
      post project_users_url, params: { project_user: { project_id: @project_user.project_id, role: @project_user.role, user_id: @project_user.user_id } }
    end
  ...
  test "should update project_user" do
    patch project_user_url(@project_user), params: { project_user: { project_id: @project_user.project_id, role: @project_user.role, user_id: @project_user.user_id } }
